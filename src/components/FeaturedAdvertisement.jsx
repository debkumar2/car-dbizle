    ...
    return (
        <div className='container mx-auto'>
            <div className="commonHeading mt-[40px] text-center mb-[22px]">
                <h2 className='text-[30px] font-semibold text-[#d8262e]'>Featured Advertisements</h2>
                <p>Featured Advertisements</p>
            </div>
            <div className="featuredMainCard grid grid-cols-4 gap-6">
                {featuredCarList.slice(0,4).map((car,index) => (
                    <div className='featureCard shadow-md border border-[#00000026] rounded-lg hover:shadow-xl/20 transition-all duration-300'>
